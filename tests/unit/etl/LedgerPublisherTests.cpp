...
static auto constexpr kACCOUNT = "rf1BiGeXwwQoi8Z2ueFYTEXSwuJYfV2Jpn";
static auto constexpr kACCOUN_T2 = "rLEsXccBGNR3UPuPu2hUXPjziKC3qKSBun";
static auto constexpr kLEDGERHASH = "4BC50C9B0D8515D3EAAE1E74B29A95804346C491EE1A95BF25E4AAB854A6A652";
static auto constexpr kSEQ = 30;
static auto constexpr kAGE = 800;
...
TEST_F(ETLLedgerPublisherTest, PublishLedgerHeaderInRange)
{
    ...
    t1.transaction = createPaymentTransactionObject(kACCOUNT, kACCOUN_T2, 100, 3, kSEQ).getSerializer().peekData();
...
TEST_F(ETLLedgerPublisherTest, PublishLedgerHeaderCloseTimeGreaterThanNow)
{
    ...
    ripple::LedgerHeader dummyLedgerHeader = createLedgerHeader(kLEDGERHASH, kSEQ, 0);
...
TEST_F(ETLLedgerPublisherTest, PublishLedgerSeqMaxAttampt)
{
    ...
    static auto constexpr kMAX_ATTEMPT = 2;
...
TEST_F(ETLLedgerPublisherTest, PublishMultipleTxInOrder)
{
    ...
    TransactionAndMetadata t1;
    t1.transaction = createPaymentTransactionObject(kACCOUNT, kACCOUN_T2, 100, 3, kSEQ).getSerializer().peekData();
    t1.metadata = createPaymentTransactionMetaObject(kACCOUNT, kACCOUN_T2, 110, 30, 2).getSerializer().peekData();
    t1.ledgerSequence = kSEQ;
    t1.date = 1;
    TransactionAndMetadata t2;
    t2.transaction = createPaymentTransactionObject(kACCOUNT, kACCOUN_T2, 100, 3, kSEQ).getSerializer().peekData();
    t2.metadata = createPaymentTransactionMetaObject(kACCOUNT, kACCOUN_T2, 110, 30, 1).getSerializer().peekData();
