...
TEST_F(FeedLedgerTest, SubPub)
{
    ...
    boost::asio::spawn(ioContext, [this](boost::asio::yield_context yield) {
        ...
        auto res = testFeedPtr_->sub(yield, backend_, sessionPtr_);
        // check the response
