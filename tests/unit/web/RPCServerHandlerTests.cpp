...
{
    static auto constexpr kREQUEST = R"({
                                        "method": "server_info",
                                        "params": [{}]
                                    })";
    ...
    static auto constexpr kRESULT = "{}";
    static auto constexpr kRESPONSE = R"({
                                        "result": {
                                            "status": "success"
                                        },
                                        "warnings": [
...
TEST_F(WebRPCServerHandlerTest, HTTPForwardedPath)
{
    ...
    static auto constexpr kRESULT = R"({
                                        "result": {
                                            "index": 1
                                        },
                                        "forwarded": true
...
TEST_F(WebRPCServerHandlerTest, HTTPErrorPath)
{
    ...
    static auto constexpr kREQUEST_JSON = R"({
                                            "method": "ledger",
                                            "params": [
                                                {
                                                "ledger_index": "xx"
...
{
    static auto constexpr kREQUEST = R"({"method": "subscribe"})";
...
{
    static auto constexpr kREQUEST = R"({"method2": "server_info"})";

    backend_->setRange(kMINSEQ, kMAXSEQ);

    static auto constexpr kRESPONSE = "Null method";
...
{
    static auto constexpr kREQUEST = R"({"method": 1})";

    backend_->setRange(kMINSEQ, kMAXSEQ);

    static auto constexpr kRESPONSE = "method is not string";
...
{
    static auto constexpr kREQUEST = R"({"method": ""})";

    backend_->setRange(kMINSEQ, kMAXSEQ);

    static auto constexpr kRESPONSE = "method is empty";
...
{
    static auto constexpr kRESPONSE = "params unparseable";
...
TEST_F(WebRPCServerHandlerTest, WsTooBusy)
{
    ...
    static auto constexpr kRESPONSE =
        R"({
            "error": "tooBusy",
            "error_code": 9,
...
{
    static auto constexpr kREQUEST = "not json";
    static auto constexpr kRESPONSE_PREFIX = "Unable to parse JSON from the request";
...
generateInvalidVersions()
{
    return std::vector<InvalidAPIVersionTestBundle>{
        {"v0", "0", fmt::format("Requested API version is lower than minimum supported ({})", rpc::kAPI_VERSION_MIN)},
        {"v4", "4", fmt::format("Requested API version is higher than maximum supported ({})", rpc::kAPI_VERSION_MAX)},
