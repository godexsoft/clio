...
TEST_F(DeprecatedTests, Field)
{
    ...
    ASSERT_TRUE(warning);
    EXPECT_EQ(
        warning->warningCode, WarningCode::WarnRpcDeprecated
...
TEST_F(DeprecatedTests, FieldWithStringValue)
{
    ...
    EXPECT_EQ(
        warning->extraMessage, "Value 'some_value' for field 'some_string' is deprecated"
    );  // NOLINT(bugprone-unchecked-optional-access)
...
TEST_F(DeprecatedTests, FieldWithIntValue)
{
    ...
    EXPECT_EQ(
        warning->extraMessage, "Value '42' for field 'some_number' is deprecated"
    );  // NOLINT(bugprone-unchecked-optional-access)
...
TEST_F(DeprecatedTests, FieldWithBoolValue)
{
    ...
    EXPECT_EQ(
        warning->extraMessage, "Value 'false' for field 'some_bool' is deprecated"
    );  // NOLINT(bugprone-unchecked-optional-access)
...
TEST_F(DeprecatedTests, FieldWithFloatValue)
{
    ...
    EXPECT_EQ(
        warning->extraMessage, "Value '3.14' for field 'some_float' is deprecated"
    );  // NOLINT(bugprone-unchecked-optional-access)
