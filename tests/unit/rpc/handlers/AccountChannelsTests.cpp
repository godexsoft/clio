...
TEST_F(RPCAccountChannelsHandlerTest, DefaultParameterTest)
{
    ...
    std::vector<Blob> bbs;
    ripple::STObject const channel1 = createPaymentChannelLedgerObject(kACCOUNT, kACCOUN_T2, 100, 10, 32, kTXNID, 28);
...
TEST_F(RPCAccountChannelsHandlerTest, UseLimit)
{
    ...
    while ((repetitions--) != 0) {
        ...
        ripple::STObject const channel =
            createPaymentChannelLedgerObject(kACCOUNT, kACCOUN_T2, 100, 10, 32, kTXNID, 28);
...
TEST_F(RPCAccountChannelsHandlerTest, UseDestination)
{
    ...
    while ((repetitions--) != 0) {
        indexes.emplace_back(kINDE_X1);
        ripple::STObject const channel =
            createPaymentChannelLedgerObject(kACCOUNT, kACCOUN_T3, 100, 10, 32, kTXNID, 28);
        bbs.push_back(channel.getSerializer().peekData());
    }
...
TEST_F(RPCAccountChannelsHandlerTest, OptionalResponseField)
{
    ...
    // return two payment channel objects
    std::vector<Blob> bbs;
    ripple::STObject channel1 = createPaymentChannelLedgerObject(kACCOUNT, kACCOUN_T2, 100, 10, 32, kTXNID, 28);
