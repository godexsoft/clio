...
constexpr static auto kSEQ = 30;
constexpr static auto kWRONG_AMM_ACCOUNT = "000S7XL6nxRAi7JcbJcn1Na179oF300000";
constexpr static auto kAMM_ACCOUNT = "rLcS7XL6nxRAi7JcbJcn1Na179oF3vdfbh";
constexpr static auto kAMM_ACCOUN_T2 = "rnW8FAPgpQgA6VoESnVrUVJHBdq9QAtRZs";
constexpr static auto kLP_ISSUE_CURRENCY = "03930D02208264E2E40EC1B0C09E4DB96EE197B1";
constexpr static auto kNOTFOUND_ACCOUNT = "rBdLS7RVLqkPwnWQCT2bC6HJd6xGoBizq8";
constexpr static auto kAMMID = 54321;
...
TEST_F(RPCAMMInfoHandlerTest, AccountNotFound)
{
    ...
    auto const accountRoot = createAccountRootObject(kAMM_ACCOUNT, 0, 2, 200, 2, kINDE_X1, 2);
...
TEST_F(RPCAMMInfoHandlerTest, AMMAccountAmmBlobNotFound)
{
    ...
    auto accountRoot = createAccountRootObject(kAMM_ACCOUNT, 0, 2, 200, 2, kINDE_X1, 2);
    auto ammObj = createAmmObject(kAMM_ACCOUN_T2, "XRP", ripple::toBase58(ripple::xrpAccount()), "JPY", kAMM_ACCOUN_T2);
...
TEST_F(RPCAMMInfoHandlerTest, AMMAccountAccBlobNotFound)
{
    auto const lgrInfo = createLedgerHeader(kLEDGERHASH, 30);
    auto const accountKey = getAccountKey(kAMM_ACCOUNT);
    auto const account2Key = getAccountKey(kAMM_ACCOUN_T2);
    auto const ammId = ripple::uint256{kAMMID};
    auto const ammKeylet = ripple::keylet::amm(ammId);

    auto accountRoot = createAccountRootObject(kAMM_ACCOUNT, 0, 2, 200, 2, kINDE_X1, 2);
    auto const ammObj =
        createAmmObject(kAMM_ACCOUN_T2, "XRP", ripple::toBase58(ripple::xrpAccount()), "JPY", kAMM_ACCOUN_T2);
...
TEST_F(RPCAMMInfoHandlerTest, HappyPathMinimalFirstXRPNoTrustline)
{
    ...
    auto const account2 = getAccountIdWithString(kAMM_ACCOUN_T2);
    ...
    auto ammObj = createAmmObject(
        kAMM_ACCOUNT, "XRP", ripple::toBase58(ripple::xrpAccount()), "JPY", kAMM_ACCOUN_T2, kLP_ISSUE_CURRENCY
    );
...
TEST_F(RPCAMMInfoHandlerTest, HappyPathWithAccount)
{
    ...
    auto accountRoot = createAccountRootObject(kAMM_ACCOUNT, 0, 2, 200, 2, kINDE_X1, 2);
    accountRoot.setFieldH256(ripple::sfAMMID, ammKey);
    auto const account2Root = createAccountRootObject(kAMM_ACCOUN_T2, 0, 2, 300, 2, kINDE_X1, 2);
    auto const ammObj = createAmmObject(
        kAMM_ACCOUN_T2, "XRP", ripple::toBase58(ripple::xrpAccount()), "JPY", kAMM_ACCOUNT, kLP_ISSUE_CURRENCY
    );
    ...
    auto const trustline = createRippleStateLedgerObject(
        kLP_ISSUE_CURRENCY, kAMM_ACCOUNT, 12, kAMM_ACCOUN_T2, 1000, kAMM_ACCOUNT, 2000, kINDE_X1, 2
    );
...
TEST_F(RPCAMMInfoHandlerTest, HappyPathMinimalSecondXRPNoTrustline)
{
    ...
    auto accountRoot = createAccountRootObject(kAMM_ACCOUNT, 0, 2, 200, 2, kINDE_X1, 2);
    auto ammObj = createAmmObject(
        kAMM_ACCOUNT, "JPY", kAMM_ACCOUN_T2, "XRP", ripple::toBase58(ripple::xrpAccount()), kLP_ISSUE_CURRENCY
    );
    accountRoot.setFieldH256(ripple::sfAMMID, ammKey);
    auto const feesObj = createLegacyFeeSettingBlob(1, 2, 3, 4, 0);
...
TEST_F(RPCAMMInfoHandlerTest, HappyPathNonXRPNoTrustlines)
{
    ...
    auto accountRoot = createAccountRootObject(kAMM_ACCOUNT, 0, 2, 200, 2, kINDE_X1, 2);
    auto ammObj = createAmmObject(kAMM_ACCOUNT, "USD", kAMM_ACCOUNT, "JPY", kAMM_ACCOUN_T2, kLP_ISSUE_CURRENCY);
    accountRoot.setFieldH256(ripple::sfAMMID, ammKey);
    auto const feesObj = createLegacyFeeSettingBlob(1, 2, 3, 4, 0);
...
TEST_F(RPCAMMInfoHandlerTest, HappyPathFrozen)
{
    ...
    auto const trustline1BalanceFrozen = createRippleStateLedgerObject(
        "USD", kAMM_ACCOUNT, 8, kAMM_ACCOUNT, 1000, kAMM_ACCOUN_T2, 2000, kINDE_X1, 2, ripple::lsfGlobalFreeze
    );
    auto const trustline2BalanceFrozen = createRippleStateLedgerObject(
        "JPY", kAMM_ACCOUNT, 12, kAMM_ACCOUN_T2, 1000, kAMM_ACCOUNT, 2000, kINDE_X1, 2, ripple::lsfGlobalFreeze
    );
...
TEST_F(RPCAMMInfoHandlerTest, HappyPathFrozenIssuer)
{
    ...
    auto accountRoot = createAccountRootObject(kAMM_ACCOUNT, ripple::lsfGlobalFreeze, 2, 200, 2, kINDE_X1, 2);
    auto ammObj = createAmmObject(kAMM_ACCOUNT, "USD", kAMM_ACCOUNT, "JPY", kAMM_ACCOUN_T2, kLP_ISSUE_CURRENCY);
    accountRoot.setFieldH256(ripple::sfAMMID, ammKey);
    auto const feesObj = createLegacyFeeSettingBlob(1, 2, 3, 4, 0);
...
TEST_F(RPCAMMInfoHandlerTest, HappyPathWithTrustline)
{
    ...
    auto const trustlineBalance = createRippleStateLedgerObject(
        "JPY", kAMM_ACCOUN_T2, -8, kAMM_ACCOUNT, 1000, kAMM_ACCOUN_T2, 2000, kINDE_X2, 2, 0
    );
...
TEST_F(RPCAMMInfoHandlerTest, HappyPathWithAssetsMatchingInputOrder)
{
    ...
    auto accountRoot = createAccountRootObject(kAMM_ACCOUNT, 0, 2, 200, 2, kINDE_X1, 2);
    auto ammObj = createAmmObject(kAMM_ACCOUNT, "JPY", kAMM_ACCOUNT, "USD", kAMM_ACCOUN_T2, kLP_ISSUE_CURRENCY);
