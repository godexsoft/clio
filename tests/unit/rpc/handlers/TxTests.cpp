...
auto constexpr static kTXNID = "05FB0EB4B899F056FA095537C5817163801F544BAFCEA39C995D76DB4D16F9DD";
auto constexpr static kNFTID = "05FB0EB4B899F056FA095537C5817163801F544BAFCEA39C995D76DB4D16F9DF";
auto constexpr static kNFTI_D2 = "05FB0EB4B899F056FA095537C5817163801F544BAFCEA39C995D76DB4D16F9DA";
constexpr static auto kLEDGERHASH = "4BC50C9B0D8515D3EAAE1E74B29A95804346C491EE1A95BF25E4AAB854A6A652";
auto constexpr static kACCOUNT = "rf1BiGeXwwQoi8Z2ueFYTEXSwuJYfV2Jpn";
auto constexpr static kACCOUN_T2 = "rLEsXccBGNR3UPuPu2hUXPjziKC3qKSBun";
auto constexpr static kCURRENCY = "0158415500000000C1F76FF6ECB0BAC600000000";
constexpr static auto kCTID = "C002807000010002";  // seq 163952 txindex 1 netid 2
constexpr static auto kSEQ_FROM_CTID = 163952;
auto constexpr static kDEFAULT_OUT_1 = R"({
...
auto constexpr static kDEFAULT_OUT_2 = R"({
    "hash": "2E2FBAAFF767227FE4381C4BE9855986A6B9F96C62F6E443731AB36F7BBB8A08",
...
TEST_F(RPCTxTest, DefaultParameter_API_v1)
{
    ...
    runSpawn([this](auto yield) {
        ...
        EXPECT_EQ(*output.result, json::parse(kDEFAULT_OUT_1));
    });
}
...
{
    TransactionAndMetadata tx;
    tx.transaction = createPaymentTransactionObject(kACCOUNT, kACCOUN_T2, 2, 3, 300).getSerializer().peekData();
    tx.metadata = createPaymentTransactionMetaObject(kACCOUNT, kACCOUN_T2, 110, 30).getSerializer().peekData();
    tx.date = 123456;
    tx.ledgerSequence = 100;
...
TEST_F(RPCTxTest, DefaultParameter_API_v2)
{
    ...
    runSpawn([this](auto yield) {
        ...
        auto const output = handler.process(req, Context{.yield = yield, .apiVersion = 2u});
        ASSERT_TRUE(output);
        EXPECT_EQ(*output.result, json::parse(kDEFAULT_OUT_2));
    });
}
...
{
    TransactionAndMetadata tx = createAcceptNftOfferTxWithMetadata(kACCOUNT, 1, 50, kNFTID);
...
{
    std::vector<std::string> ids{kNFTID, kNFTI_D2};
...
{
    TransactionAndMetadata tx = createCreateNftOfferTxWithMetadata(kACCOUNT, 1, 50, kNFTID, 123, kNFTI_D2);
    ...
    runSpawn([this](auto yield) {
        ...
        auto const output = handler.process(req, Context{yield});
        ASSERT_TRUE(output);
        EXPECT_TRUE(output.result->at("meta").at("offer_id").as_string() == kNFTI_D2);
    });
}
...
TEST_F(RPCTxTest, ViaCTID)
{
    ...
    tx1.transaction = createCreateOfferTransactionObject(kACCOUNT, 2, 100, kCURRENCY, kACCOUN_T2, 200, 300)
                          .getSerializer()
                          .peekData();
    tx1.date = 123456;
    ...
    tx2.transaction = createPaymentTransactionObject(kACCOUNT, kACCOUN_T2, 2, 3, 300).getSerializer().peekData();
    tx2.metadata = createPaymentTransactionMetaObject(kACCOUNT, kACCOUN_T2, 110, 30).getSerializer().peekData();
