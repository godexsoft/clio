...
{
    auto constexpr static kOUTPUT = R"({
    ...
    auto const ownerDir = createOwnerDirLedgerObject(
        {ripple::uint256{kINDE_X1}, ripple::uint256{kINDE_X2}, ripple::uint256{kINDE_X2}}, kINDE_X1
    );
    ...
    auto const line2 = createRippleStateLedgerObject("JPY", kISSUER, 100, kACCOUN_T2, 10, kACCOUNT, 20, kTXNID, 123, 0);
    ...
    auto const line3 = createRippleStateLedgerObject("EUR", kISSUER, 8, kACCOUNT, 10, kACCOUN_T2, 20, kTXNID, 123, 0);
    std::vector<Blob> bbs;
