    ...
    EXPECT_CALL(
        *backend_,
        fetchNFTTransactions(
            testing::_, testing::_, true, testing::Optional(testing::Eq(TransactionsCursor{kMINSEQ + 1, 0})), testing::_
        )
    )
        .Times(1);
...
TEST_F(RPCNFTHistoryHandlerTest, IndexNotSpecificForwardTrue)
{
    ...
    EXPECT_CALL(
        *backend_,
        fetchNFTTransactions(
            testing::_, testing::_, true, testing::Optional(testing::Eq(TransactionsCursor{kMINSEQ, 0})), testing::_
        )
    )
        .Times(1);
