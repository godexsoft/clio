...
constexpr static auto kCLIENTIP = "1.1.1.1";
...
TEST_F(RPCServerInfoHandlerTest, NoLedgerHeaderErrorsOutWithInternal)
{
    ...
    auto const handler = AnyHandler{TestServerInfoHandler{
        backend_, mockSubscriptionManagerPtr, mockLoadBalancerPtr_, mockETLServicePtr_, *mockCountersPtr_
    }};
...
TEST_F(RPCServerInfoHandlerTest, DefaultOutputIsPresent)
{
    ...
    EXPECT_CALL(*rawBalancerPtr, forwardToRippled(testing::_, testing::Eq(kCLIENTIP), false, testing::_))
