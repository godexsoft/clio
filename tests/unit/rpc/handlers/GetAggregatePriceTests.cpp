...
constexpr static auto kT_X1 = "E6DBAFC99223B42257915A63DFC6B0C032D4070F9A574B255AD97466726FC321";
constexpr static auto kT_X2 = "E6DBAFC99223B42257915A63DFC6B0C032D4070F9A574B255AD97466726FC322";
constexpr static auto kINDEX = "13F1A95D7AAB7108D5CE7EEAF504B2894B8C674E6D68499076441C4837282BF8";
...
TEST_F(RPCGetAggregatePriceHandlerTest, OracleLedgerEntrySinglePriceData)
{
    ...
    auto constexpr kDOCUMENT_ID = 1;
    mockLedgerObject(*backend_, kACCOUNT, kDOCUMENT_ID, kT_X1, 1e3, 2);  // 10
...
TEST_F(RPCGetAggregatePriceHandlerTest, NewLedgerObjectHasNoPricePair)
{
    ...
    EXPECT_CALL(*backend_, fetchTransaction(ripple::uint256(kT_X1), _))
...
TEST_F(RPCGetAggregatePriceHandlerTest, OracleLedgerEntryMultipleOraclesOdd)
{
    ...
    auto constexpr kDOCUMENT_ID1 = 1;
    auto constexpr kDOCUMENT_ID2 = 2;
    auto constexpr kDOCUMENT_ID3 = 3;
    mockLedgerObject(*backend_, kACCOUNT, kDOCUMENT_ID1, kT_X1, 1e3, 2);  // 10
    mockLedgerObject(*backend_, kACCOUNT, kDOCUMENT_ID2, kT_X1, 2e3, 2);  // 20
    mockLedgerObject(*backend_, kACCOUNT, kDOCUMENT_ID3, kT_X1, 3e3, 1);  // 300
...
TEST_F(RPCGetAggregatePriceHandlerTest, OracleLedgerEntryMultipleOraclesEven)
{
    ...
    auto constexpr kDOCUMENT_ID2 = 2;
    auto constexpr kDOCUMENT_ID3 = 3;
    auto constexpr kDOCUMENT_ID4 = 4;
    mockLedgerObject(*backend_, kACCOUNT, kDOCUMENT_ID1, kT_X1, 1e3, 2);  // 10
    mockLedgerObject(*backend_, kACCOUNT, kDOCUMENT_ID2, kT_X1, 2e3, 2);  // 20
    mockLedgerObject(*backend_, kACCOUNT, kDOCUMENT_ID4, kT_X1, 4e2, 1);  // 40
    mockLedgerObject(*backend_, kACCOUNT, kDOCUMENT_ID3, kT_X1, 3e3, 1);  // 300
...
TEST_F(RPCGetAggregatePriceHandlerTest, NoOracleEntryFound)
{
    ...
    EXPECT_CALL(*backend_, doFetchLedgerObject(oracleIndex, kRANGEMAX, _)).WillOnce(Return(std::nullopt));
...
TEST_F(RPCGetAggregatePriceHandlerTest, TimeThresholdIsZero)
{
    ...
    auto constexpr kDOCUMENT_ID3 = 3;
    auto constexpr kDOCUMENT_ID4 = 4;
    auto constexpr kTIMESTAMP1 = 1711461384u;
    auto constexpr kTIMESTAMP2 = 1711461383u;
    auto constexpr kTIMESTAMP3 = 1711461382u;
    auto constexpr kTIMESTAMP4 = 1711461381u;
    mockLedgerObject(*backend_, kACCOUNT, kDOCUMENT_ID1, kT_X1, 1e3, 2, kTIMESTAMP1);  // 10
    mockLedgerObject(*backend_, kACCOUNT, kDOCUMENT_ID2, kT_X1, 2e3, 2, kTIMESTAMP2);  // 20
    mockLedgerObject(*backend_, kACCOUNT, kDOCUMENT_ID4, kT_X1, 4e2, 1, kTIMESTAMP3);  // 40
    mockLedgerObject(*backend_, kACCOUNT, kDOCUMENT_ID3, kT_X1, 3e3, 1, kTIMESTAMP4);  // 300
...
TEST_F(RPCGetAggregatePriceHandlerTest, NotFoundInTxHistory)
{
    ...
    EXPECT_CALL(*backend_, fetchTransaction(ripple::uint256(kT_X2), _))
        .WillRepeatedly(Return(createOracleSetTxWithMetadata(
            kACCOUNT,
            kRANGEMAX,
            123,
