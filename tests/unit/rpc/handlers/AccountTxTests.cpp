...
constexpr static auto kNFTID = "05FB0EB4B899F056FA095537C5817163801F544BAFCEA39C995D76DB4D16F9DF";
constexpr static auto kNFTI_D2 = "05FB0EB4B899F056FA095537C5817163801F544BAFCEA39C995D76DB4D16F9DA";
constexpr static auto kNFTI_D3 = "15FB0EB4B899F056FA095537C5817163801F544BAFCEA39C995D76DB4D16F9DF";
...
genTransactions(uint32_t seq1, uint32_t seq2)
{
    ...
    ripple::STObject const obj = createPaymentTransactionObject(kACCOUNT, kACCOUN_T2, 1, 1, 32);
    trans1.transaction = obj.getSerializer().peekData();
    trans1.ledgerSequence = seq1;
    ripple::STObject const metaObj = createPaymentTransactionMetaObject(kACCOUNT, kACCOUN_T2, 22, 23);
    trans1.metadata = metaObj.getSerializer().peekData();
    trans1.date = 1;
    transactions.push_back(trans1);

    auto trans2 = TransactionAndMetadata();
    ripple::STObject const obj2 = createPaymentTransactionObject(kACCOUNT, kACCOUN_T2, 1, 1, 32);
    trans2.transaction = obj.getSerializer().peekData();
    trans2.ledgerSequence = seq2;
    ripple::STObject const metaObj2 = createPaymentTransactionMetaObject(kACCOUNT, kACCOUN_T2, 22, 23);
...
genNFTTransactions(uint32_t seq)
{
    ...
    auto trans2 = createAcceptNftOfferTxWithMetadata(kACCOUNT, 1, 50, kNFTI_D2);
    trans2.ledgerSequence = seq;
    trans2.date = 2;
    transactions.push_back(trans2);

    auto trans3 = createCancelNftOffersTxWithMetadata(kACCOUNT, 1, 50, std::vector<std::string>{kNFTI_D2, kNFTI_D3});
    trans3.ledgerSequence = seq;
    trans3.date = 3;
    transactions.push_back(trans3);

    auto trans4 = createCreateNftOfferTxWithMetadata(kACCOUNT, 1, 50, kNFTID, 123, kNFTI_D2);
...
TEST_P(AccountTxTransactionTypeTest, SpecificTransactionType)
{
    ...
    ON_CALL(*backend_, fetchAccountTransactions).WillByDefault(Return(transCursor));
    EXPECT_CALL(
        *backend_, fetchAccountTransactions(_, _, false, Optional(Eq(TransactionsCursor{kMAXSEQ, INT32_MAX})), _)
    )
        .Times(1);
