...
{
    static auto constexpr kNUM_ADDITIONS = 1000;
    static auto constexpr kNUM_NUMBER_ADDITIONS = 100;
    static auto constexpr kNUMBER_TO_ADD = 11;
    std::thread thread1([&] {
...
TEST_F(CounterDoubleTests, multithreadAdd)
{
    static auto constexpr kNUM_ADDITIONS = 1000;
    static auto constexpr kNUM_NUMBER_ADDITIONS = 100;
    static auto constexpr kNUMBER_TO_ADD = 11.1234;
    std::thread thread1([&] {
        for (int i = 0; i < kNUM_ADDITIONS; ++i) {
            ++counter;
        }
