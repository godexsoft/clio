...
static FieldSpecProcessor const emptyFieldProcessor = [](boost::json::value&) -> MaybeError { return {}; };
...
static FieldChecker const emptyFieldChecker = [](boost::json::value const&) -> check::Warnings { return {}; };
