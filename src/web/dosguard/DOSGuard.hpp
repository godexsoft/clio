...
public:
    static constexpr std::uint32_t defaultMaxFetches = 1000'000u; /**< Default maximum fetches per sweep */
    static constexpr std::uint32_t defaultMaxConnections = 20u;   /**< Default maximum concurrent connections */
    static constexpr std::uint32_t defaultMaxRequests = 20u;      /**< Default maximum requests per sweep */
