...
public:
    ...
    static constexpr std::chrono::seconds defaultTimeout{5}; /**< Default timeout for connecting */
};
...
class WsConnectionBuilder {
    ...
    std::chrono::steady_clock::duration connectionTimeout_{defaultTimeout};
    std::chrono::steady_clock::duration wsHandshakeTimeout_{defaultTimeout};
    std::string target_{"/"};
