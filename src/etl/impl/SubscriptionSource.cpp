...
SubscriptionSource::handleMessage(std::string const& message)
{
    ...
    try {
        ...
        static constexpr char const* const kJS_LEDGER_CLOSED = "ledgerClosed";
        static constexpr char const* const kJS_VALIDATION_RECEIVED = "validationReceived";
        static constexpr char const* const kJS_MANIFEST_RECEIVED = "manifestReceived";
